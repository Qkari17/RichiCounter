      ...
      <main className="flex-1 p-4 bg-blue-600 rounded-2xl flex-col flex justify-between  overflow-hidden">
        <div className="flex justify-center">
          <div className="flex flex-col items-center rotate-180">
            <h1 className={playerList[3].loser && "text-red-500"}>{playerList[3].name} North</h1>
            <p className={isMenu ? "" : "hidden"}>{playerList[3].points}</p>
          </div>
        </div>
        <div className="  flex justify-between">
          <div className="rotate-90 flex flex-col items-center">
            <h1 className={playerList[2].loser && "text-red-500"}>{playerList[2].name} West</h1>
          ...
          <div className="-rotate-90 flex flex-col items-center">
            <h1 className={playerList[1].loser && "text-red-500"}>{playerList[1].name} South</h1>
            <p className={isMenu ? "" : "hidden"}>{playerList[1].points}</p>
          </div>
        </div>
        <div className="flex justify-center">
          <div className="flex flex-col items-center">
            <h1 className={playerList[0].loser && "text-red-500"}>{playerList[0].name} East</h1>
